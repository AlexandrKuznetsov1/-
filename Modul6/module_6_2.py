...
# Необходимо создать 2 класса: Vehicle и Sedan, где Vehicle - это любой транспорт,
...
class Vehicle:
    ...
    def __init__(self, owner, model, color, engine_power):
        ...
        self.__engine_power = int(
            engine_power)  # мощность двигателя. (мы не можем менять мощность двигателя самостоятельно)
    ...
    def set_color(self, new_color):
        ...
        if self.new_color.lower() in self.__COLOR_VARIANTS:
            ...
            print(Fore.RED + f'Нельзя сменить цвет на {self.new_color}', Style.RESET_ALL)
