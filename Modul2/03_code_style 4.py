...
my_poem[-1] = "Eсли долго мучаться, что-нибудь получится!"
...
B = 43
if A < B:
    print('i j k - для циклов')
C = 9
if C > 0:
    print('x y z - для координат')
print('никогда не используйте в названиях переменных одиночные "l, I, O" !')
